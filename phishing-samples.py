...
phishurl = data.sample(n = 500, random_state = 12).copy()
...
phishing_dataset = pd.DataFrame(phishingFeatures, columns= featureNames)
phishing_dataset.head()

phishing_dataset.to_csv('p500.csv', index= False)